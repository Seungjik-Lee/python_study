from sklearn.model_selection import train_test_split #훈련데이터와 테스트데이터를 나누기
import numpy as np
from sklearn.neighbors import KNeighborsClassifier #최근접 분류 알고리즘
